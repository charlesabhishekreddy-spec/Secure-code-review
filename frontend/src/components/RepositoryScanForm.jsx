export function RepositoryScanForm({ value, onChange, onSubmit, disabled }) {
  return (
      ...
      <div className="flex flex-col gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-300">
            Paste a public GitHub repository URL to scan Python, JavaScript, TypeScript, and Java source files.
          </p>
        </div>
